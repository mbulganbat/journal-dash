...
export const CustomDropdown = ({ label, value, options, onChange, icon: Icon }: { label?: string, value: string, options: {value: string, label: string}[], onChange: (val: string) => void, icon?: React.ElementType }) => {
